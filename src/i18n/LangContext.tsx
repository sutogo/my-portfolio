...
const translations: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    'timeline.grad.subtitle': '【The Integration】ハードとソフトの融合，そして世界へ',
    'timeline.short.title': '福岡工業大学短期大学部（情報メディア学科）',
    'timeline.short.subtitle': '【The Pivot】ソフトウェアと論理の世界へ',
    'timeline.trajectory.title': '株式会社トラジェクトリー（長崎・対馬事務所）',
    'timeline.trajectory.subtitle': '【The Pioneer】0→1の立ち上げと，カオスの形式知化',
    'timeline.aisin.title': 'アイシングループ（自動車部品メーカー）',
    'timeline.aisin.subtitle': '【The Professional】徹底した現場改善と品質へのこだわり',
  ...
  en: {
    ...
    'timeline.grad.subtitle': '【The Integration】Merging HW & SW, reaching the world',
    ...
    'timeline.trajectory.subtitle': '【The Pioneer】Building from zero, formalizing chaos',
    'timeline.aisin.title': 'AISIN Group (Automotive Parts Manufacturer)',
    'timeline.aisin.subtitle': '【The Professional】Relentless kaizen & quality commitment',
